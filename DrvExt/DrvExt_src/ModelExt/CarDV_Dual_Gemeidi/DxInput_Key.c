...
#define VOLDET_KEY_ADC_LVL1         (366-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2         (570-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (750-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (890-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (890+VOLDET_KEY_ADC_RANGE)
...
static UINT32 VolDet_GetKey1Level(void)
{
    ...
    if (uiKey1ADC < VOLDET_KEY_ADC_TH)
    {
        ...
        {
            uiCurKey2Lvl = VOLDET_KEY_LVL_MODE;//no use
        } 
