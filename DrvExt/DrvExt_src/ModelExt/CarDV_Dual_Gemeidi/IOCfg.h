...
#define GPIO_LCD_SIF_SCK            L_GPIO_27//L_GPIO_21 //EVB
...
#define GPIO_LCD_RESET              L_GPIO_21// P_GPIO_36 //PWM0, no use
#endif
...
//--------------------------------------------------------------------
// Sensor
#define GPIO_SENSOR_RESET           S_GPIO_26
...
#define GPIO_SENSOR2_PDN            S_GPIO_25
...
extern void GPIOMap_TurnOnWhiteLight(void);
extern void GPIOMap_TurnOffWhiteLight(void);
extern BOOL GPIOMap_IsWhiteLightOn(void);
// White Light control
#define GPIO_WHITE_LIGHT                P_GPIO_10
#define PAD_WHITE_LIGHT                 PAD_PIN_PGPIO10

extern UINT32 GPIOMap_ACCDet(void);

extern BOOL GPIOMap_IsReverseGear(void);
#define GPIO_REVERSE_GEAR_DET          D_GPIO_3
#define PAD_REVERSE_GEAR_DET          PAD_PIN_DGPIO3
