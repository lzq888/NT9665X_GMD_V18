#ifndef IQS_SETTINGTABLE_IMX322LQJ_EVB_FF_H
#define IQS_SETTINGTABLE_IMX322LQJ_EVB_FF_H
...
extern UINT8 PRE_ShadingLut[Total_ZOOMNum][17];
...
extern FOV DCE_Fov[Total_ZOOMNum];
extern EnH DCE_Enh[Total_ZOOMNum];
extern Fact_Norm DCE_NormTerm[Total_SENMODENum];
extern Aberation DCE_ColorAbbration[Total_ZOOMNum];
extern UINT32 DCE_2D_LUT[Total_ZOOMNum][65];
...
extern INT8 Contrast[Total_ISONum][2];
