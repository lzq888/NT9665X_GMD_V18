...
INT32 System_OnVideoAttach(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    //SysSetCVBSOutputEn(FALSE);
	 ...
	 Display_ShowSplash(SPLASH_POWERON,1);
	GxVideo_SetDeviceCtrl(DOUT1, DISPLAY_DEVCTRL_BACKLIGHT, TRUE);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,2);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,3);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,4);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,5);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,6);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,7);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,8);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,9);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,10);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,11);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,12);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,13);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,14);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,15);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,16);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,17);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,18);
        Delay_DelayMs(60);
        Display_ShowSplash(SPLASH_POWERON,19);
...
void Display_ShowSplash(SPLASH_ID splash_id,UINT32 Index)
{
    UINT32  uiPoolAddr;

    //#PR_WIN#michael#2013/01/08-begin
    #if (UPDATE_CFG == UPDATE_CFG_YES)
    if (splash_id == SPLASH_POWERON)
    {
        if (UI_ShowLogoFile(UI_LOGO_POWERON))
        {
            return ;
        }
    }
    ...
    {
        if (UI_ShowLogoFile(UI_LOGO_POWEROFF))
        {
            return ;
        }
    }
    #endif
    //#PR_WIN#michael#2013/01/08-end
    ...
    if (splash_id == SPLASH_POWERON)
    {
        ...
        p_gLogoJPG = (UINT32)g_ucBGOpening1;
        p_gLogoSize = Logo_getBGOpening_size1();}		
        else if(Index == 2){
        p_gLogoJPG = (UINT32)g_ucBGOpening2;
        p_gLogoSize = Logo_getBGOpening_size2();}	
        else if(Index == 3){
        p_gLogoJPG = (UINT32)g_ucBGOpening3;
        p_gLogoSize = Logo_getBGOpening_size3();}	
        else if(Index == 4){
        p_gLogoJPG = (UINT32)g_ucBGOpening4;
        p_gLogoSize = Logo_getBGOpening_size4();}	
        else if(Index == 5){
        p_gLogoJPG = (UINT32)g_ucBGOpening5;
        p_gLogoSize = Logo_getBGOpening_size5();}	
        else if(Index == 6){
        p_gLogoJPG = (UINT32)g_ucBGOpening6;
        p_gLogoSize = Logo_getBGOpening_size6();}	
        else if(Index == 7){
        p_gLogoJPG = (UINT32)g_ucBGOpening7;
        p_gLogoSize = Logo_getBGOpening_size7();}	
        else if(Index == 8){
        p_gLogoJPG = (UINT32)g_ucBGOpening8;
        p_gLogoSize = Logo_getBGOpening_size8();}	
        else if(Index == 9){
        p_gLogoJPG = (UINT32)g_ucBGOpening9;
        p_gLogoSize = Logo_getBGOpening_size9();}
        else if(Index == 10){
        p_gLogoJPG = (UINT32)g_ucBGOpening10;
        p_gLogoSize = Logo_getBGOpening_size1();}		
        else if(Index == 11){
        p_gLogoJPG = (UINT32)g_ucBGOpening11;
        p_gLogoSize = Logo_getBGOpening_size12();}		
        else if(Index == 12){
        p_gLogoJPG = (UINT32)g_ucBGOpening12;
        p_gLogoSize = Logo_getBGOpening_size12();}	
        else if(Index == 13){
        p_gLogoJPG = (UINT32)g_ucBGOpening13;
        p_gLogoSize = Logo_getBGOpening_size13();}	
        else if(Index == 14){
        p_gLogoJPG = (UINT32)g_ucBGOpening14;
        p_gLogoSize = Logo_getBGOpening_size14();}	
        else if(Index == 15){
        p_gLogoJPG = (UINT32)g_ucBGOpening15;
        p_gLogoSize = Logo_getBGOpening_size15();}	
        else if(Index == 16){
        p_gLogoJPG = (UINT32)g_ucBGOpening16;
        p_gLogoSize = Logo_getBGOpening_size16();}	
        else if(Index == 17){
        p_gLogoJPG = (UINT32)g_ucBGOpening17;
        p_gLogoSize = Logo_getBGOpening_size17();}	
        else if(Index == 18){
        p_gLogoJPG = (UINT32)g_ucBGOpening18;
        p_gLogoSize = Logo_getBGOpening_size18();}	
        else if(Index == 19){
        p_gLogoJPG = (UINT32)g_ucBGOpening19;
        p_gLogoSize = Logo_getBGOpening_size19();}
