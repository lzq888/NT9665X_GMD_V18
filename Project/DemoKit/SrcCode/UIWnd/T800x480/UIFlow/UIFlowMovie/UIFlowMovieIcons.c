...
void FlowMovie_IconHideRecording(void)
{
    UxCtrl_SetShow(&UIFlowWndMovie_Status_RECCtrl, FALSE);    
}
void FlowMovie_IconDrawRecording(void)
{
    UxCtrl_SetShow(&UIFlowWndMovie_Status_RECCtrl, TRUE);
}
