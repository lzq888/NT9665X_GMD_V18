...
INT32 UIFlowWndPhoto_ReverseGear(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_REVERSEGEAR,UIFlowWndPhoto_ReverseGear)
...
static void UIFlowWndPhoto_InitCfgSetting(void)
{
    ...
    //Ux_SendEvent(&CustomMovieObjCtrl, NVTEVT_EXE_DUAL_REC, 1, SysGetFlag(FL_MOVIE_DUAL_REC));
