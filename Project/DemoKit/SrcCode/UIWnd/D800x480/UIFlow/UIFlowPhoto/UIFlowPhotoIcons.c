...
void FlowPhoto_IconDrawGuideLine(void)
{
#if (_MODEL_DSC_ == _MODEL_DUAL_GEMEIDI_)
UxCtrl_SetShow(&UIFlowWndPhoto_Static_GuideCtrl, FALSE);
#else
    UxCtrl_SetShow(&UIFlowWndPhoto_Static_GuideCtrl, TRUE);
#endif
}

void FlowPhoto_IconHideGuideLine(void)
{
    UxCtrl_SetShow(&UIFlowWndPhoto_Static_GuideCtrl, FALSE);
}
