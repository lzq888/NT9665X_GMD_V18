...
INT32 UIMenuWndSetupDateTime_OnReverseGear(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_REVERSEGEAR,UIMenuWndSetupDateTime_OnReverseGear)
...
INT32 UIMenuWndSetupDateTime_OnReverseGear(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    Ux_CloseWindow(&MenuCommonItemCtrl,0); // close whole tab menu
    return NVTEVT_CONSUME;
}
